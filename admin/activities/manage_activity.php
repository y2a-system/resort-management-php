        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select name="status" id="status" class="form-control form-control-border" placeholder="Enter activity Name" required>
            ...
            $.ajax({
                ...
                success:function(resp){
                    if(resp.status == 'success'){
                        location.href = './?route=activities/view_activity&id='+resp.id;
                    }else if(!!resp.msg){
