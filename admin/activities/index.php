...
<div class="card card-outline card-dark rounded-0 shadow">
	<div class="card-header">
		<h3 class="card-title">List of Acitivities</h3>
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-sm btn-dark"><span class="fas fa-plus"></span>  Add New Activity</a>
		</div>
	</div>
	<div class="card-body">
								...
								<?php 
									switch ($row['status']){
										case 0:
											...
											break;
										case 1:
											echo '<span class="rounded-pill badge badge-success col-6">Active</span>';
											break;
									}
								?>
							</td>
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
								  	<a class="dropdown-item" href="./?route=activities/view_activity&id=<?= $row['id'] ?>" data-id ="<?php echo $row['id'] ?>"><span class="fa fa-eye text-dark"></span> View</a>
...
<script>
	$(document).ready(function(){
        $('#create_new').click(function(){
			uni_modal("Add New activity","activities/manage_activity.php",'mid-large')
		})
        $('.edit_data').click(function(){
			uni_modal("Update activity Details","activities/manage_activity.php?id="+$(this).attr('data-id'),'mid-large')
		})
		$('.delete_data').click(function(){
			_conf("Are you sure to delete this activity permanently?","delete_activity",[$(this).attr('data-id')])
		})
		$('.view_data').click(function(){
			uni_modal("activity Details","activities/view_activity.php?id="+$(this).attr('data-id'))
		})
