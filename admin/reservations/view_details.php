...
if(isset($_GET['id'])){
    ...
    if($qry->num_rows > 0){
        ...
        echo '<script> alert("Unkown Reservation ID.");location.replace("./?route=reservations") </script>';
    }
} else{
    echo '<script> alert("Reservation ID is required to view this page.");location.replace("./?route=reservations") </script>';
}
